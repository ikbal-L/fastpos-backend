...
//        initiateDB();
    ...
    public void initiateDB(){
        ...
        Terminal terminal1 = Terminal.builder().isActive(true).licenceKey(UUID.randomUUID().toString()).annex(createdAnnex1).build();
        Terminal terminal2 = Terminal.builder().isActive(true).licenceKey(UUID.randomUUID().toString()).annex(createdAnnex2).build();
        Terminal terminal3 = Terminal.builder().isActive(true).licenceKey(UUID.randomUUID().toString()).annex(createdAnnex3).build();
